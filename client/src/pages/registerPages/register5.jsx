...
<div className="eventCard eventCardExp">
             ...
             <div className="eventName">  <span style={{  fontFamily:"jedi",fontSize:"2.5rem"}} className='gradient-text' > DroidKick</span>   </div>
             ...
             <div className="eventName"> <span style={{  fontFamily:"jedi",fontSize:"1.1rem"}} className='gradient-text' > venue</span> : Canteen 1st floor</div>
...
<iframe width="100%" height="100%" style={{border:"none"}} src="https://www.yepdesk.com/embed/buy-tickets/6624247346e0fb0001bfe2ef/private/617tpp4lk6"></iframe>
</div>
)}
