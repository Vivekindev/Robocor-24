...
<div className="eventCard_event">
             ...
             <div id="left"> <img class="eventImage_event"src={starlink} style={{borderRadius:"1rem"}}></img></div>
            
             <div id="right"> 
             <div className="rightTop">
             <div className="eventName_event">  <span style={{  fontFamily:"jedi",fontSize:"3rem"}} className='gradient-text' > starlink </span>   </div>
...
<span style={{  fontFamily:"jedi",fontSize:"4rem",marginBottom:"0rem"}} className='gradient-text' > register</span>
    ...
    <div className="eventCard_Int">
             <img class="eventImage_Int"src={starlink} style={{borderRadius:"1rem"}}></img> 
             <div className="eventName_Int">  <span style={{  fontFamily:"jedi",fontSize:"2.5rem"}} className='gradient-text' > starlink</span>   </div>
...
<iframe onLoad={()=>setIframe(true)} width="100%" height="100%" style={{border:"none"}} src="https://www.yepdesk.com/embed/buy-tickets/66241e4e46e0fb0001bfd5e3/private/arhel4ecqi"></iframe>
</div>
</>
)}
