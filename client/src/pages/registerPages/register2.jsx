...
<div className="eventCard eventCardExp">
             ...
             <div className="eventName">  <span style={{  fontFamily:"jedi",fontSize:"2.5rem"}} className='gradient-text' > droidrace</span>   </div>
             ...
             <span style={{  fontFamily:"jedi",fontSize:"1.1rem"}} className='gradient-text' > venue</span> : Indoor Stadium
             </div>
...
<iframe width="100%" height="100%" style={{border:"none"}} src="https://www.yepdesk.com/embed/buy-tickets/662134e346e0fb0001b00640/private/bn2feesp74"></iframe>
</div>
)}
